...
urlpatterns = [
    ...
    path('detail/<int:pk>/', views.TodoRetrieveUpdateDestroyView.as_view(), name='todo_detail'),
    path('toggle/<int:pk>/', views.TodoToggleView.as_view(), name='todo_toggle'),
    path('monthly-rate/<int:year>/<int:month>/', views.MonthlyCompletionRateView.as_view(), name='monthly_completion_rate'),
]