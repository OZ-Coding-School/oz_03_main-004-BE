...
class GetCommitDataViewTestCase(TestCase):
    def setUp(self):
        ...
        self.user = User.objects.create_user(email='testuser@example.com', password='testpassword', nickname='testnickname')
    ...
    def test_get_commit_data_success(self, mock_github, mock_decrypt_cookie):
        ...
        self.assertJSONEqual(response.content, {
            'commit_count': 1,
            'latest_commit_date': '2024-07-19T12:00:00'
        })
    ...
    def test_get_commit_data_token_not_found(self):
        ...
        self.assertJSONEqual(response.content, {'error': 'GitHub token not found in cookies'})
